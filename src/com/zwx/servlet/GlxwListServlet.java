...
public class GlxwListServlet extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
           ...
           request.setCharacterEncoding("UTF-8");
		    ...
		    List<Article> xwlist= articleBiz.getArticleByMenuId(menuId);
		    if(xwlist.size()>0){
		    	request.setAttribute("xwlist", xwlist);
		    	request.getRequestDispatcher("xwlist.jsp").forward(request, response);
		    }
	}
