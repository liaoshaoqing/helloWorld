...
public class YsbjListServlet extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
	    ...
	    List<Article> yslist= articleBiz.getArticleByMenuId(menuId);
	    if(yslist.size()>0){
	    	request.setAttribute("yslist", yslist);
	    	request.getRequestDispatcher("yslist.jsp").forward(request, response);
	    }
